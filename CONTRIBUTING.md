...
- alterações multi-tenant incluem `organizationId` na autorização e preservam as constraints descritas em `docs/architecture/DATA_AND_TENANCY.md`;
- API e worker continuam com entrypoints separados;
- decisões de ownership, processo ou contrato público atualizam `ARCHITECTURE.md` e um ADR.

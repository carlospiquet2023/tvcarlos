...
- Vitest: autenticação, hashing, tokens, validação, ciclo de conteúdo, auditoria, limites e ordenação.
...
- Docker health checks: PostgreSQL, API e Nginx; a programação FFmpeg é observada separadamente pelo status HLS.

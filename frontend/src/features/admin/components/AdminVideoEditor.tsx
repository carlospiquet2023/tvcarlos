...
export function AdminVideoEditor({ blocks, form, mode, token, onBlocksChange, onClose, onFormChange, onModeChange, onSave }: AdminVideoEditorProps) {
    return (
